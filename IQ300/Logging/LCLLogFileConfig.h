...
#define _LCLLogFile_AppName [[[NSBundle mainBundle] executablePath] lastPathComponent]

#define _LCLLogFile_LogFileName [NSString stringWithFormat:@"%@.log", _LCLLogFile_AppName]
...
#define _LCLLogFile_LogFilePath /* (NSString *) */                                      \
    [[[NSHomeDirectory() stringByAppendingPathComponent:@"Library/Logs"]                \
                         stringByAppendingPathComponent:_LCLLogFile_AppName]            \
                         stringByAppendingPathComponent:_LCLLogFile_LogFileName]
