...
expectedTotalBytes:(int64_t)expectedTotalBytes {
    if(_progressHandler) {
        _progressHandler((NSInteger)fileOffset, fileOffset, expectedTotalBytes);
    }
}
...
totalBytesExpectedToWrite:(int64_t)totalBytesExpectedToWrite {
    if(_progressHandler) {
        _progressHandler((NSInteger)bytesWritten, totalBytesWritten, totalBytesExpectedToWrite);
    }
}
