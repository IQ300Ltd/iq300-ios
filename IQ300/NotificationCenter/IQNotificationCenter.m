...
NSString * const IQConversationDidRemovedNotification = @"conference_participant_removed";
...
NSString * const IQUserDidChangeStatusNotification = @"users_status_changed";
