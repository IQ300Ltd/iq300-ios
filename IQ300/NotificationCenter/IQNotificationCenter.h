...
extern NSString * const IQTaskCommentsDidChangedNotification;
...
extern NSString * const IQFeedbackDidChangedNotification;
extern NSString * const IQUserDidChangeStatusNotification;
