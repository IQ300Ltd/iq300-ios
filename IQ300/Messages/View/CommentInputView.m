...
- (id)init {
    ...
    if (self) {
        ...
        [_sendButton setBackgroundColor:[UIColor colorWithHexInt:0x48cd52]];
        [_sendButton setBackgroundColor:[UIColor colorWithHexInt:0x40b549] forState:UIControlStateHighlighted];
